...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            arguments=['0.0', '0.00', '0.0','0.0', '0.0', '0.0', 'base_link', 'rslidar'], # Change Sensor Frame.
            output='screen'
        ),
        ...
        Node(
            ...
            parameters=[
                {'lidar_type': 'robosense'},            # LiDAR type: 'ouster' or 'robosense'
                {'in_cloud_aux': '/rslidar_points'},    # Aux LiDAR Topic if available. If "aux_lidar_en = False" this topic will be ignored.
                {'in_cloud': '/rslidar_points'},        # Principal LiDAR Topic.
                {'hz_cloud': 10.0},                     # Principal LiDAR Hz.
                {'in_imu': '/imu/data'},                # IMU Topic.
                {'hz_imu': 100.0},                      # IMU Hz
                {'calibration_time': 1.0},              # Only if the vehicle stay still before moving
                {'aux_lidar_en': False},                # If only one LiDAR available make sure to set this parameter to False
